...
#warning pio/hello_pio example requires a board with a regular LED
    ...
    bool success = pio_claim_free_sm_and_add_program_for_gpio_range(&test_program, &pio, &sm, &offset, HELLO_PIO_LED_PIN, 1, true);
    hard_assert(success);
    ...
    pio_remove_program_and_unclaim_sm(&test_program, pio, sm, offset);
#endif
}
